# -*- coding: utf-8 -*-
"""
Created on Mon Aug 24 12:20:29 2020
...
'''
To see the structure of the nested data first run the file 
into json.dumps() function and put the printed information into json editor 

which is available online and its URL is
...
import json 
print(json.dumps(res, indent =2)) # for jason editor view

# as we know out data is dictionary so 
#Q we want to extact user infroamtion
...
print(len(res['statuses'])) # look its have 3 tweet 

resoriginal=(res['statuses'])

user_information=[]
#for res1 in resoriginal[:1]: for checking one by one tweet 
for res1 in resoriginal[:1]:    
    #print(type(res1))
    #print(res1.keys())# we can see only user key can have user information
    #print(type(res1['user']))
    res2=res1['user']
    #print(res2.keys())
    print(res2['screen_name'],res2['created_at'])
    
    
    
# 2nd method 

for res4 in res['statuses']:
    print(res4['user']['screen_name'],res4['user']['created_at'])
